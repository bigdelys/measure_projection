...
if size(s,2)==3 & size(s,1) ~= 3% disabled by nima since it creates an error if only 3 points are presented (it think we are using a different addressing scheme)
