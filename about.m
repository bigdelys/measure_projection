...
% Last Modified by GUIDE v2.5 12-Sep-2011 17:39:56
...
% set the text to the version of MPT read from .hgtags (from Mercurial)
set(hObject, 'String', pr.getVersionString);
